...
namespace SuperAdeventureConsole
{
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Connect the player events to functions that will display in the UI
            ...
            while (true)
            {
                ...
                //Convert to lower-case to make comparisons
                string cleanedInput = userInput.ToLower();

                //Save the current game data and break out of the while loop
        ...
        private static void ParseInput(string input)
        {
            if (input == "help" || input == "?")
            {
                ...
                Console.WriteLine("Quest - Display your quests");
                ...
                Console.WriteLine("Trade - display your inventory and the vendor's inventory");
            ...
            else if (input.Contains("attack"))
            {
                ...
                else
                {
                    ...
                    {
                        //Select the first weapon in the player's inventory, null if they dont have any
            ...
            else if(input.StartsWith("equip "))
            {
                ...
                {
                    Console.WriteLine("You must enter the name of the weapon to equip it");
                }
                else
                {
                    ...
                    {
                        Console.WriteLine("You dont have the weapon: {0}", inputWeaponName);
                    }
                    else
                    {
                        _player.CurrentWeapon = weaponToEquip;

                        Console.WriteLine("You euqip your {0}", _player.CurrentWeapon.Name);
                    }
                }
            }
            else if(input.StartsWith("drink "))
            {
                ...
                {
                    HealingPotion potionToDrink = _player.Potions.SingleOrDefault(
                        x => x.Name.ToLower() == inputPotionName || x.NamePlural.ToLower() == inputPotionName);

                    if(potionToDrink == null)
                    {
                        Console.WriteLine("You dont have the potion: {0}", inputPotionName);
                    }
                    else
                    {
            ...
            else if(input.StartsWith("buy "))
            {
                ...
                else
                {
                    ...
                    {
                        //Get the II from the Traders Inventory
                        ...
                        else
                        {
                            ...
                            {
                                Console.WriteLine("You dont have enough gold to buy a {0}", itemToBuy.Description);
                            }
                            else
                            {
                                //Sucess!!!11
            ...
            else if(input.StartsWith("sell "))
            {
                ...
                else
                {
                    ...
                    {
                        //Get the Inventory Item from the player's inventory
                        ...
                        if(itemToSell == null)
                        {
                            Console.WriteLine("The player can not sell any {0}", itemName);
                        }
                        else
                        {
                            //Sell the item
                            _player.RemoveItemFromInventory(itemToSell.Details);
                            _player.Gold += itemToSell.Details.Price;
            ...
            //Write a line to keep the UI a little cleaner
            Console.WriteLine("");
        }
